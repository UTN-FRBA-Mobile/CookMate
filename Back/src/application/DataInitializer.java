    ...
    private static String getDefaultRecipesJson() {
        Recipe[] defaultRecipes = new Recipe[]{
                new Recipe("Tarta de Manzana", "tartaManzana", new Step[]{
                        new Step(1, "Precalentar el horno a 180 grados Celsius.", "horno", new Ingredient[]{}, 5),
                ...
                new Recipe("Pizza Margarita", "pizzaMargarita", new Step[]{
                        new Step(1, "Precalentar el horno a 220 grados Celsius.", "horno", new Ingredient[]{}, 5),
                ...
                new Recipe("Hamburguesa", "hamburguesa", new Step[]{
                        ...
                        new Step(5, "Colocar la carne cocinada dentro del pan.", "hamburguesa", new Ingredient[]{}, 5)
                }),
                new Recipe("Papas fritas", "papasFritas", new Step[]{
                        new Step(1, "Precalentar aceite en una sartén a 220 grados Celsius.", "sartenAceite", new Ingredient[]{}, 5),
